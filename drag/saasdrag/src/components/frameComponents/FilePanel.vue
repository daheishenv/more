    ...
    >
        ...
        >
            <template v-if="data.type === 'folder'">
                ...
                <div style="color: #ccc">
                    <i
                        class="el-icon-upload right-icon"
                        style="margin-right: 5px"
                        @click="updateFolder(data)"
                    ></i>
                    <i
                        class="el-icon-plus right-icon"
                        @click="addFile(data,node)"
                        style="margin-right: 5px"
                    ></i>
                    <!--<i class="el-icon-edit right-icon" style="margin-right: 5px"></i>-->
                    <i
                        class="el-icon-delete right-icon"
                        style="margin-right: 5px"
            ...
            <template v-else>
                ...
                <div style="color: #ccc">
                    <i
                        class="el-icon-upload right-icon"
                        style="margin-right: 5px"
                        @click.stop="updateFile(data)"
                    ></i>
                    <!--<i class="el-icon-edit right-icon" style="margin-right: 5px"></i>-->
                    <i
                        class="el-icon-delete right-icon"
                        style="margin-right: 5px"
                        @click.stop="deleteFolder(node,data,$event)"
                    ></i>
                </div>
            </template>
        </span>
...
import { outCommonExportFile, outExportFolder, outExportStr, outExportFileByStr } from '@/utils/outExportFile'
