...
<script>
import listMixins from 'zzsp-saas-ui/common/mixins/list.js'
...
export default {
    ...
    computed: {
        ...
        skeleton_() {
            switch (this.type) {
                case 'normal_no_title': return 'skeleton-screen/gc-recommend-goods-no-title.png'
                case 'package': return 'skeleton-screen/gc-recommend-goods-no-cart.png'
                default: return 'skeleton-screen/gc-recommend-goods.png'
            }
        },
        loadMore_() {
        ...
        noData_() {
            return this.finish && this.pageList.length === 0
        }
    },
    watch: {
        ajaxParams: {
...
<style lang="scss">
    .gc-recommend-goods{
        /deep/ .gc-list-item{
            box-shadow: 0px 0px 8rpx 0px rgba(202, 202, 202, 0.58) !important;
        }
    }
</style>
