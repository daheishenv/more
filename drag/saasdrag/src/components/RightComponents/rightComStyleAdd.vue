    ...
    <el-form :rules="rules"  :model="form"  ref="ruleForm" label-width="80px">
        ...
        <el-form-item label="值类型" prop="type">
            <el-select v-model="form.type"  size="mini" placeholder="请选择值的输入类型"
                       @change="selectCheck"
            >
                <el-option :label="item.label" :value="item.value" :key="index" v-for="(item, index) in selectType"></el-option>
            </el-select>
        </el-form-item>
        ...
        <el-card class="box-card" v-if="typeIsSelect" style="margin-bottom: 20px;">
            <div style="display: flex;flex-wrap: wrap;justify-content: center">
                <div style="width: 100%;display: flex;margin-top: 10px;align-items: center" :key="index" v-for="(item,index) in selectKeyValue">
