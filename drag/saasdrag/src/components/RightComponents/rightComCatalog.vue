...
import { outExportFolder } from '@/utils/outExportFile'
import store from 'vuex'
import { mapState } from 'vuex'

//二开
import { indexData } from '@/utils/utils'
...
export default {
    ...
    methods: {
        ...
        // 二开
        choose(event) {
            let project_ = this.$store.state.project.list[event];
            this.$store.commit('setCheckFile', indexData(project_));
        }
    },
    computed: {
        currentProjcetName: {
