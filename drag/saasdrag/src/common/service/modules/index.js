...
import logisticsServices from './logisticsServices.js';
import shop from './shop.js';
import activity from './activity.js';
import package from './package.js';
modules = {
    ...common, ...goods, ...guset, ...home, ...login, ...user, ...order, ...goodsSpike, ...goodsTeam, ...topic, ...logisticsServices, ...activity, ...shop, ...package
}
// #endif
