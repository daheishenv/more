...
const shareDefault = {
    ...
    jsdomainList: ['updateTimelineShareData', 'updateAppMessageShareData'] // 分享的JSSDK列表
}
...
// {value: 3, label: "PC"}
// {value: 4, label: "微信H5"}
const platformType = 6

export default { platformType, fullPageCatch, domainList, ossImgUrl, version, ossFileName, shopUid, userVersion, shareDefault, priceNullText, stockNullText, templateId, appId, projectSource }
