                ...
                <view>
                    ...
                    <view class="multi-cell flex-ajcenter p24">
                        ...
                        <view class="multi-cell__content plr24">
                            ...
                            <view class="color-999 pt12 fs-24">{{ summary || '' }}</view>
                        </view>
...
export default {
    ...
    computed: {
        ...
        posterHeight_() {
            return (Number(this.imgHeight) + 220) * 0.8
        }
    },
    watch: {
        value: {
    ...
    methods: {
        ...
        async shareFc() {
            ...
            const height = Number(imgHeight) + 220
            const namePy = this.summary ? 0 : 28
            try {
                        ...
                        return new Promise((rs, rj) => {
                            const postArr = [
                                ...
                                // 用户头像
                                {
                                    ...
                                    // alpha: .3,
                                    dx: u24,
                                    dy: bgObj.height - 50 - userImgSize,
                                    dWidth: userImgSize,
                                    dHeight: userImgSize,
                                    circleSet: true
                                },
                                // 用户名
                                {
                                    ...
                                    textBaseline: 'middle',
                                    serialNum: 1,
                                    dx: userImgSize + 2 * u24,
                                    dy: bgObj.height - 126 + namePy,
                                    lineFeed: {
                                        maxWidth: bgObj.width - 2.5 * userImgSize - userImgSize,
                                        lineNum: 1
                                    }
                                },
                                // 简介
                                {
                                    type: 'text',
                                    text: this.summary ? this.summary : '',
                                    size: 0.7 * fontSize,
                                    color: '#999999',
                                    textAlign: 'left',
                                    textBaseline: 'middle',
                                    ...
                                    dy: bgObj.height - 82,
                                    lineFeed: {
                                        maxWidth: bgObj.width - 2.5 * userImgSize - 4 * u24,
                                        lineHeight: 28,
                                        lineNum: 1
                                    }
                                },
                                // 二维码
                                {
                                    ...
                                    dx: bgObj.width - u24 - 1.5 * userImgSize,
                                    dy: bgObj.height - 200,
